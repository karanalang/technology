...
class Solution:
    ...
    def maxSubArray_BruteForce(self,nums:List[int]) -> int:
        ...
        subArrays = self.listArrays(nums)
    ...
    def maxSubArray_DivideConquer(self, nums:List[int]) -> int:
        return 0
    ...
    def maxSubArray_Kadane(self, nums:List[int]) -> int:
        ...
        for i in range(1, len(nums)):
            print(' - max_current + nums[i] - ', max_current + nums[i])
    ...
    def listArrays(self, nums: List[int]) -> int:
