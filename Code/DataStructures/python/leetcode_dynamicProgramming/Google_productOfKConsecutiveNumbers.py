    ...
    def prodOfKConsecutiveNos_dp_1(self, nums, k):
        ...
        for i in range(1, k):
            for j in range(i, width):
                print(" 1. i -> ", i , ' , j -> ', j, ' calculating dp[', j, '] , (j - i) -> ', (j - i), " nums[j - i]  ", nums[j - i])
                dp[j] *= nums[j - i]
        return dp
...
print("prodOfKConsecutiveNos_dp_1, res_dp_2 -> ", res_dp_2)

# res_dp_3 = google.consecutive_products(l2, k)
# print("consecutive_products , res_dp_3 -> ", res_dp_3)

# res_dp_4 = google.soln(l2, k)
# print("soln, res_dp_4  -> ", res_dp_4)